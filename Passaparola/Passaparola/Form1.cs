...
namespace Passaparola
{
    public partial class Form1 : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (soruno == 1)
            {
                richTextBox1.Text = "Avrupada en büyük ülke?";
                button1.BackColor = Color.Yellow;
            }
            if (soruno == 2)
            {
                richTextBox1.Text = "Sınıfta bir eşya, her ülkede var, Türkiyenin rengi kırmızı ve beyaz";
            ...
            if (soruno == 12)
            {
                richTextBox1.Text = "Malatyanın meşhur meyvvesi?";
